      ...
      <section className="container home">
        ...
        <div className="features-container">
          ...
          <div className="feature-card books-feature">
            ...
            <h3>Books</h3>
            <p>
              Organize your reading collection and discover new books to
              explore.
            </p>
        ...
        <div className="benefits-section">
          ...
          <div className="benefits-grid">
            ...
            <div className="benefit-item">
              <h4>User-Friendly</h4>
              <p>
                Clean, intuitive interface inspired by your favorite Google
                apps.
              </p>
            </div>
            <div className="benefit-item">
            ...
            <div className="benefit-item">
              ...
              <p>
                Keep your important information safe and accessible anytime.
              </p>
            </div>
          </div>
        </div>
