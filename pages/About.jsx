      ...
      <section className="container-about">
        <div className="about-header">
          ...
          <p className="about-intro">
            ...
            features of email management, note-taking, and book organization in
        ...
        <div className="applications-section">
          ...
          <div className="app-card mail-app">
            ...
            <div className="app-details">
              ...
              <p>
                ...
                intuitive interface inspired by Gmail. Organize your messages
                with custom folders, filter important emails, and never miss a
                critical conversation again.
              </p>
          ...
          <div className="app-card notes-app">
            ...
            <div className="app-details">
              ...
              <p>
                ...
                designed to help you organize ideas, create to-do lists, and
                store important information. Inspired by Google Keep, our Notes
                app combines simplicity with powerful features.
              </p>
              <ul className="feature-list">
                <li>
          ...
          <div className="app-card books-app">
            ...
            <div className="app-details">
              <h3>Books</h3>
              <p>
                Manage your reading life with our Books application. Keep track
                of your collection, discover new titles, and organize your
                library effortlessly. Perfect for book lovers who want to
                maintain a digital catalog of their reading journey.
              </p>
              <ul className="feature-list">
                <li>
                  <i className="material-icons">check_circle</i> Virtual
                  bookshelf organization
                </li>
                <li>
                  <i className="material-icons">check_circle</i> Reading
                  progress tracking
                </li>
                <li>
          ...
          <div className="team-grid">
            <div className="team-member">
              <div className="member-avatar">
                <img
                  src="https://i.ibb.co/YBC3zbtp/Whats-App-Image-2025-03-05-at-14-23-59-2ba0b7d4.jpg"
                  alt="Maor Yadegar"
            ...
            <div className="team-member">
              <div className="member-avatar">
                <img
                  src="https://media.licdn.com/dms/image/v2/C5603AQH31o8SLsFpaQ/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1581796164531?e=1746662400&v=beta&t=VKVHAr0rlWu-tzPVNYV_v6qj8z4K9BhrtwWVtUFC9WU"
                  alt="Maor Yadegar"
                  className="avatar-image"
                />
              </div>
        ...
        <div className="mission-section">
          ...
          <p>
            ...
            We're committed to developing tools that enhance productivity
