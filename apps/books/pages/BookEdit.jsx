...
const navigate = useNavigate()
    ...
    const { title, listPrice, description, pageCount, publishedDate, thumbnail, authors, categories } = bookToEdit
    ...
    return (
        <section className="book-edit">
            ...
            <form className="book-edit-form" onSubmit={onSaveBook}>
                ...
                <input type="number" id="pageCount" value={pageCount} onChange={handleChange} name="pageCount" />

                <label htmlFor="publishedDate">Published Date:</label>
                <input type="date" id="publishedDate" value={publishedDate} onChange={handleChange} name="publishedDate" />
