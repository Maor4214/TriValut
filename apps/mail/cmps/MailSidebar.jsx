...
export function MailSidebar({ isSideBarOpen, openCompose }) {
  ...
  return (
    <ul className={`mail-side-bar ${isSideBarOpen ? '' : 'close'}`}>
      <li>
        <a onClick={openCompose} href="#" className="compose-btn">
          <svg
      ...
      <li>
        <NavLink to="/mail/inbox" data-tooltip="Inbox">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="24px"
            viewBox="0 -960 960 960"
      ...
      <li>
        <NavLink to="/mail/starred" data-tooltip="Starred">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="24px"
            viewBox="0 -960 960 960"
      ...
      <li>
        <NavLink to="/mail/sent" data-tooltip="Sent">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="24px"
            viewBox="0 -960 960 960"
      ...
      <li>
        <NavLink to="/mail/draft" data-tooltip="Drafts">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="24px"
            viewBox="0 -960 960 960"
      ...
      <li>
        <NavLink to="/mail/trash" data-tooltip="Trash">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="24px"
            viewBox="0 -960 960 960"
